<?php
include_once $_SERVER['OLDPWD']."/connect.php";
include_once $_SERVER['OLDPWD']."/lib/common.php";
    ...
    if ($row['push_use_YN'] == 'Y') {
        ...
        $query_2 = "select * from `raw_data` where address='{$address}' and board_type='{$board_type}' and board_number='{$board_number}'  order by idx desc limit 0,1";
